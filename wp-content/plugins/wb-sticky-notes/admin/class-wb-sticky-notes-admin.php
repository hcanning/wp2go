...
class Wb_Sticky_Notes_Admin {
	...
	public function plugin_action_links($links)
	{
		...
		$links[]='<a href="https://webbuilder143.com/support-our-work/?utm_source=plugin&utm_medium=plugins-page&utm_campaign=links&utm_id=notes-plugin&utm_content=donate" target="_blank" style="color:#06bb06; font-weight:700;">'.__('Donate', 'wb-sticky-notes').'</a>';
		return $links;
	}
